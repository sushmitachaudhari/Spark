...
object TwitterFollowerCountRDDG {
  ...
  /**
    ...
    */
    ...
    def main(args: Array[String]): Unit = {
      ...
      logger.info(followerCount.getStorageLevel)

      logger.info(followerCount.getNumPartitions)

      //scala functions :
      /*edgesFile.toDebugString
      followerCount.toDebugString
      followerCount.getNumPartitions
      followerCount.getStorageLevel*/
    }
  }
